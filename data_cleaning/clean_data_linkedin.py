"""Clean and deduplicate linkedin jobs.
...
identically.
    ...
    python -m data_cleaning/clean_data_linkedin --input <parsed.json> --output <cleaned.json>
...
DEFAULT_INPUT = "Linkedin/linkedin_parsed_jobs.json"
DEFAULT_OUTPUT = "cleaned/linkedin.json"
SOURCE = "linkedin"


def main() -> int:
    args = build_arg_parser(
        "Clean and deduplicate linkedin jobs", DEFAULT_INPUT, DEFAULT_OUTPUT
    ).parse_args()
    logging.basicConfig(
