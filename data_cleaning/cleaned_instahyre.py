"""Clean and deduplicate instahyre jobs.
...
identically.
    ...
    python -m data_cleaning/cleaned_instahyre --input <parsed.json> --output <cleaned.json>

For a full run, prefer: ``python -m jobai ingest --sources instahyre``
"""
...
DEFAULT_INPUT = "cleaned/instahyre_jobs.json"
DEFAULT_OUTPUT = "cleaned/instahyre.json"
SOURCE = "instahyre"


def main() -> int:
    args = build_arg_parser(
        "Clean and deduplicate instahyre jobs", DEFAULT_INPUT, DEFAULT_OUTPUT
    ).parse_args()
    logging.basicConfig(
