...
linkedin = r"E:\JOB.ai\JOB.ai\result_of_all_web_scraper\cuvette.json"
...
for job in unique_data[:]:  # Iterate over a copy of the list to modify it while looping
    if "job_description" in job:
        ...
        job['skills'] = " ".join(re.split(r'[\/,]', job['skills'])) # Join the skills as a string
        ...
        job['Source']='cuvette'
        job['yoe']=extract_yoe(job['years_of_experience'])
    else:
...
output_file = "E:/JOB.ai/JOB.ai/cleaned/cleaned_cuvete.json"
