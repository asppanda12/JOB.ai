"""Clean and deduplicate naukri jobs.
...
identically.
    ...
    python -m data_cleaning/clean_data_naukri --input <parsed.json> --output <cleaned.json>
...
DEFAULT_INPUT = "naukri/naukri_parsed_jobs.json"
DEFAULT_OUTPUT = "cleaned/naukri.json"
SOURCE = "naukri"


def main() -> int:
    args = build_arg_parser(
        "Clean and deduplicate naukri jobs", DEFAULT_INPUT, DEFAULT_OUTPUT
    ).parse_args()
    logging.basicConfig(
